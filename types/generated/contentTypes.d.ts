...
export interface ApiFlightFlight extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    arrivesAt: Schema.Attribute.Time;
    code: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    departedAt: Schema.Attribute.Time;
    destination: Schema.Attribute.String;
    flightStatus: Schema.Attribute.Enumeration<['No hor\u00E1rio', 'Atrasado']>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::flight.flight'
    ...
    publishedAt: Schema.Attribute.DateTime;
    type: Schema.Attribute.Enumeration<['Partida', 'Chegada']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    imageSlider: Schema.Attribute.DynamicZone<['elements.image']> &
    ...
    pageContent: Schema.Attribute.DynamicZone<
      ['elements.car-reservation-banner']
    > &
      Schema.Attribute.SetMinMax<
        {
          max: 1;
...
export interface ApiPrivatePagePrivatePage extends Struct.SingleTypeSchema {
